import{j as c}from"./jsx-runtime-e7d94ccb.js";import{c as $}from"./index-f7beeda4.js";import{r as b}from"./index-981f9478.js";import{a,g as e,r as i}from"./getTheme-9564f801.js";const o=a.input`
  width: 100%;
  cursor: pointer;
...
`,d=b.forwardRef((l,g)=>{const{size:r="md",iconPrefix:s,iconSuffix:n,disabled:f,activeDropdown:m,negative:h,...p}=l;return c.jsx(x,{className:$({iconPrefix:s,negative:h,activeDropdown:m}),$size:r,$activeDropdown:m,children:c.jsxs(v,{children:[s&&c.jsx(t,{$size:r,children:s}),c.jsx(o,{...p,ref:g,disabled:f,$size:r,autoComplete:"off"}),n&&c.jsx(u,{$size:r,$disabled:f,children:n})]})})});d.displayName="FISSelectItem";try{d.displayName="FISSelectItem",d.__docgenInfo={description:"",displayName:"FISSelectItem",props:{size:{defaultValue:null,description:"Control the size of the component",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},iconPrefix:{defaultValue:null,description:"Prefix for filter value",name:"iconPrefix",required:!1,type:{name:"string | Element"}},iconSuffix:{defaultValue:null,description:"iconSuffix for filter value",name:"iconSuffix",required:!1,type:{name:"string | Element"}},actived:{defaultValue:null,description:"actived for current field",name:"actived",required:!1,type:{name:"boolean"}},activeDropdown:{defaultValue:null,description:"active-dropdown for current field",name:"activeDropdown",required:!1,type:{name:"boolean"}},negative:{defaultValue:null,description:"negative for current field",name:"negative",required:!1,type:{name:"boolean"}}}}}catch{}export{d as F};
