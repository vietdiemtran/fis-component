import{j as i}from"./jsx-runtime-3dc6859f.js";import{r as w}from"./index-d4014758.js";import{d as n,g as e,l as o}from"./getTheme-1aacf7d7.js";import{F as v}from"./index-c8f11e24.js";import{F as z}from"./index-35e06132.js";import{b as x}from"./LineArrowsUp-143aac49.js";import{c as a}from"./index-01b5a1be.js";const y=n.div`
  display: flex;
  align-items: center;
...
`,s=w.forwardRef((t,m)=>{const{className:b,icon:d,label:p,size:c="xs",theme:l="neutral",srcAvatar:h="",closeable:u,selected:g,disabled:r,onClickClose:$,...k}=t,f=c==="xs"?"2xs":c==="sm"?"xs":c==="md"?"sm":"md";return i.jsxs(y,{...k,ref:m,$size:c,$theme:l,$disabled:r,className:a(b,{selected:g,"no-padding":u}),children:[h?i.jsx(v,{size:f,src:h,disabled:r,dotBadge:!r}):d&&i.jsx(C,{$size:c,$theme:l,$disabled:r,children:d}),i.jsx(j,{$size:c,$theme:l,$disabled:r,className:a({"no-padding":u}),children:p}),u&&i.jsx(S,{$size:c,$disabled:r,className:"button-icon",children:i.jsx(z,{size:c,variant:"tertiary-invisible",icon:i.jsx(x,{}),onClick:$,disabled:r})})]})});s.displayName="FISChipButton";const L=s;try{s.displayName="FISChipButton",s.__docgenInfo={description:"",displayName:"FISChipButton",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"red"'},{value:'"orange"'},{value:'"yellow"'},{value:'"lime"'},{value:'"green"'},{value:'"ocean"'},{value:'"blue"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}},closeable:{defaultValue:null,description:"",name:"closeable",required:!1,type:{name:"boolean"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"boolean"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},onClickClose:{defaultValue:null,description:"",name:"onClickClose",required:!1,type:{name:"(() => void)"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},srcAvatar:{defaultValue:null,description:"",name:"srcAvatar",required:!1,type:{name:"string"}}}}}catch{}export{L as F};
