import{j as l}from"./jsx-runtime-47c18db8.js";import{c as u}from"./index-d16835b1.js";import{d as f,L as x}from"./RemoveIcon-d554efb7.js";import{d as t,g as e,l as c}from"./getTheme-624682de.js";import{F as S}from"./index-ff1f41df.js";const z=t.div`
  display: flex;
...
`,P=t.div`
  ...
  ${o=>o.$disable&&c`
      color: ${e("com/menu/item/disable/icon/color-icon")};
    `}
`,$=({title:o,description:g,iconPrefix:p,type:a="action",size:v="md",selected:i=!1,negative:s=!1,disable:n,onClickMenu:h})=>{const b=()=>{switch(a){case"action":return l.jsx(S,{size:"sm",label:"New",color:"neutral-light",disabled:n});case"leveling":return l.jsx(P,{$selected:i,$disable:n,children:l.jsx(x,{})});case"select":return l.jsx(y,{$selected:i,children:l.jsx(f,{})});default:return null}};return l.jsxs(k,{className:u({negative:s}),$size:v,$selected:i,$type:a,$disable:n,onClick:h,children:[p&&l.jsx(r,{className:u({negative:s}),$size:v,$type:a,$selected:i,$disable:n,children:p}),l.jsxs(z,{children:[o&&l.jsx(m,{className:u({negative:s}),$selected:i,$type:a,$disable:n,children:o}),g&&l.jsx(d,{className:u({negative:s}),$type:a,$selected:i,$disable:n,children:g})]}),b()]})};$.displayName="FISMenuItem";const N=$;try{$.displayName="FISMenuItem",$.__docgenInfo={description:"",displayName:"FISMenuItem",props:{title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},iconPrefix:{defaultValue:null,description:"",name:"iconPrefix",required:!1,type:{name:"ReactNode"}},type:{defaultValue:{value:"action"},description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"select"'},{value:'"action"'},{value:'"leveling"'}]}},size:{defaultValue:{value:"md"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"md"'},{value:'"lg"'}]}},selected:{defaultValue:{value:"false"},description:"",name:"selected",required:!1,type:{name:"boolean"}},negative:{defaultValue:{value:"false"},description:"",name:"negative",required:!1,type:{name:"boolean"}},disable:{defaultValue:null,description:"",name:"disable",required:!1,type:{name:"boolean"}},onClickMenu:{defaultValue:null,description:"",name:"onClickMenu",required:!1,type:{name:"(() => void)"}}}}}catch{}export{N as M};
