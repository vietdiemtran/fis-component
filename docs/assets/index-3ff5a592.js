import{j as c}from"./jsx-runtime-e7d94ccb.js";import{a as s,g as o,r as e}from"./getTheme-9564f801.js";import{F as k}from"./index-66039438.js";import{r as x}from"./index-981f9478.js";const a=(r,i)=>{const l=o(`com/button/size-${r}/horizontal-padding`),d=o(i);return e`
    padding: 0 calc(${l} - ${d});
  `},f=s.button`
  display: flex;
  ...
  ${r=>{switch(r.$variant){case"primary":return e`
        ...
        `;case"secondary":return e`
          ...
          ${()=>["xs","sm","md","lg"].includes(r.$size)?a(r.$size,"com/button/secondary/border/stroke-width/default"):""}
        `;case"tertiary":return e`
          ...
          ${()=>["xs","sm","md","lg"].includes(r.$size)?a(r.$size,"com/button/tertiary/border/stroke-width/default"):""}
        ...
        `;case"secondary-white":return e`
          ...
          ${()=>["xs","sm","md","lg"].includes(r.$size)?a(r.$size,"com/button/secondary-invert/border/stroke-width/default"):""}
        `;case"secondary-ghost":return e`
          ...
          ${r.$loading&&e`
            background-color: ${o("com/button/disable/background-color-transparent")} !important;
          `}
        `;case"tertiary-ghost":return e`
          ...
          ${r.$loading&&e`
            background-color: ${o("com/button/disable/background-color-transparent")} !important;
          `}
        `;case"secondary-ghost-negative":return e`
          ...
          ${r.$loading&&e`
            background-color: ${o("com/button/disable/background-color-transparent")} !important;
          `}
        `;case"secondary-ghost-white":return e`
          background-color: ${o("com/button/secondary-invert/background/default")};
          color: ${o("com/button/secondary-invert/label/color-text/default")};
...
`,z=s(k)`
  position: absolute;
`,u=x.forwardRef((r,i)=>{const{active:l,children:d,size:m="md",variant:n="primary",loading:b,disabled:v=!1,startIcon:$,endIcon:g,...y}=r,p=$&&c.jsx(t,{children:$}),h=g&&c.jsx(t,{children:g});return c.jsxs(f,{...y,ref:i,$variant:n,$size:m,$active:l,$loading:b,disabled:v||b,children:[b&&c.jsx(z,{size:m,variant:"indeterminate",invert:n==="primary-white"||n==="secondary-white"||n==="secondary-ghost-white"}),p,c.jsx("span",{className:"button-content",children:d}),h]})});u.displayName="FISButton";try{u.displayName="FISButton",u.__docgenInfo={description:"",displayName:"FISButton",props:{active:{defaultValue:null,description:"whether the button should be active",name:"active",required:!1,type:{name:"boolean"}},variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'},{value:'"primary-negative"'},{value:'"secondary-negative"'},{value:'"primary-white"'},{value:'"secondary-white"'},{value:'"secondary-ghost"'},{value:'"tertiary-ghost"'},{value:'"secondary-ghost-negative"'},{value:'"secondary-ghost-white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},startIcon:{defaultValue:null,description:"Defines the element that stands before the children element.",name:"startIcon",required:!1,type:{name:"ReactNode"}},endIcon:{defaultValue:null,description:"Defines the element that stands after the children element.",name:"endIcon",required:!1,type:{name:"ReactNode"}},loading:{defaultValue:null,description:"Defines if the button is currently being requested.",name:"loading",required:!1,type:{name:"boolean"}}}}}catch{}export{u as F};
