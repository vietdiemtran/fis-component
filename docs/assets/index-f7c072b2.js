import{j as t}from"./jsx-runtime-3dc6859f.js";import{d as o,l as a,g as e}from"./getTheme-1aacf7d7.js";const g=o.div`
  position: relative;
  display: flex;
  align-items: center;
  ...
  ${r=>{switch(r.$color){case"neutral":return a`
    ...
    ${r=>{switch(r.$size){case"2xs":return a`
        ...
        `}}}
    ${r=>{switch(r.$shape){case"rounded":return a`
...
`,p=o.div`
  ...
  ${r=>{switch(r.$size){case"xl":return a`
          ...
          min-height: 10px;
          max-height: 10px;
          border-width: ${e("com/avatar/status-badge/size-lg/stroke-width")};
          bottom: calc(
            -${e("com/avatar/status-badge/size-lg/stroke-width")} -
              ${e("com/avatar/size-xl/stroke-width")}
          );
          right: calc(
            -${e("com/avatar/status-badge/size-lg/stroke-width")} -
        ...
        `;case"lg":return a`
          ...
          min-height: 8px;
          max-height: 8px;
          border-width: ${e("com/avatar/status-badge/size-md/stroke-width")};
          bottom: calc(
            -${e("com/avatar/status-badge/size-md/stroke-width")} -
              ${e("com/avatar/size-lg/stroke-width")}
          );
          right: calc(
            -${e("com/avatar/status-badge/size-md/stroke-width")} -
        ...
        `;case"sm":return a`
          ...
          min-height: 6px;
          max-height: 6px;
          border-width: ${e("com/avatar/status-badge/size-sm/stroke-width")};
          bottom: calc(
            -${e("com/avatar/status-badge/size-sm/stroke-width")} -
              ${e("com/avatar/size-sm/stroke-width")}
          );
          right: calc(
            -${e("com/avatar/status-badge/size-sm/stroke-width")} -
        ...
        `;case"2xs":return a`
          ...
          min-height: 4px;
          max-height: 4px;
          border-width: ${e("com/avatar/status-badge/size-xs/stroke-width")};
          bottom: calc(
            -${e("com/avatar/status-badge/size-xs/stroke-width")} -
              ${e("com/avatar/size-2xs/stroke-width")}
          );
          right: calc(
            -${e("com/avatar/status-badge/size-xs/stroke-width")} -
        ...
        `}}}
  ${r=>{switch(r.$statusBadge){case"green":return a`
        ...
        `}}}
`,d=({className:r,src:l,alt:h="Avatar",shape:s="rounded",size:i="xl",icon:u,statusBadge:$="green",color:n="neutral",letter:m,disabled:c,dotBadge:v=!1})=>t.jsxs(g,{className:r,$size:i,$shape:s,$color:n,$disabled:c,tabIndex:c?-1:0,children:[l?t.jsxs(b,{$shape:s,children:[t.jsx(x,{$shape:s,$size:i,src:l,alt:h}),c&&t.jsx(z,{})]}):u?t.jsx(w,{$size:i,$shape:s,$color:n,$disabled:c,children:u}):t.jsx(k,{$size:i,$shape:s,$color:n,$disabled:c,children:m==null?void 0:m.slice(0,2)}),v&&t.jsx(p,{$size:i,$statusBadge:$})]});d.displayName="FISAvatar";const q=d;try{d.displayName="FISAvatar",d.__docgenInfo={description:"",displayName:"FISAvatar",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},src:{defaultValue:null,description:"",name:"src",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},alt:{defaultValue:{value:"Avatar"},description:"",name:"alt",required:!1,type:{name:"string"}},letter:{defaultValue:null,description:"",name:"letter",required:!1,type:{name:"string"}},size:{defaultValue:{value:"xl"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"2xs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'}]}},statusBadge:{defaultValue:{value:"green"},description:"",name:"statusBadge",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"green"'},{value:'"red"'},{value:'"yellow"'},{value:'"blue"'}]}},dotBadge:{defaultValue:{value:"false"},description:"",name:"dotBadge",required:!1,type:{name:"boolean"}},shape:{defaultValue:{value:"rounded"},description:"",name:"shape",required:!1,type:{name:"enum",value:[{value:'"rounded"'},{value:'"square"'}]}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},color:{defaultValue:{value:"neutral"},description:"",name:"color",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"green"'},{value:'"yellow"'},{value:'"blue"'},{value:'"orange"'},{value:'"lime"'},{value:'"ocean"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}}}}}catch{}export{q as F};
