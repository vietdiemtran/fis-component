import{j as t}from"./jsx-runtime-47c18db8.js";import{d as m,g as o,l as c,n as v}from"./getTheme-624682de.js";import{T as g}from"./index-94ce6d4e.js";import{B as x}from"./button-6bebafc6.js";function y(e){return typeof e=="object"&&e!==null&&"label"in e}const s=m.div`
  display: flex;
...
`,n=m.a``,f=m.div`
  ${({$size:e,$variant:i})=>{switch(e){case"md":return c`
          ...
          ${s} {
            gap: ${o("com/tooltip/size-md/vertical-gap")};
...
`,u=({className:e,variant:i="primary",size:h="md",title:l,children:$,...b})=>{const d=v();if(y(l)){const p=t.jsxs(s,{children:[t.jsxs(k,{children:[t.jsx(r,{children:l.label}),l.description&&t.jsx(a,{children:l.description})]}),l.link&&t.jsx(n,{href:l.linkUrl,target:"_blank",rel:"noopener noreferrer",children:l.link})]});return t.jsx(f,{className:e,$size:h,$variant:i,children:t.jsx(g,{color:i==="primary"?d["com/tooltip/size-md/theme-black/background-color"]:d["com/tooltip/size-md/theme-white/background-color"],title:p,getTooltipContainer:z=>z,...b,children:$||t.jsx(x,{children:"RT"})})})}return t.jsx(f,{className:e,$size:h,$variant:i,children:t.jsx(g,{color:i==="primary"?d["com/tooltip/size-md/theme-black/background-color"]:d["com/tooltip/size-md/theme-white/background-color"],title:l,getTooltipContainer:p=>p,...b,children:$||t.jsx(x,{children:"RT"})})})};u.displayName="FISTooltip";try{u.displayName="FISTooltip",u.__docgenInfo={description:"",displayName:"FISTooltip",props:{className:{defaultValue:null,description:"Additional class names to apply to the tooltip",name:"className",required:!1,type:{name:"string"}},variant:{defaultValue:{value:"primary"},description:"The color of the tooltip",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'}]}},title:{defaultValue:null,description:"The tooltip title, which can be a custom object or a React node",name:"title",required:!0,type:{name:"ReactNode | TooltipTitleCustom"}},size:{defaultValue:{value:"md"},description:"The size of the tooltip (optional)",name:"size",required:!1,type:{name:"enum",value:[{value:'"md"'},{value:'"lg"'}]}},children:{defaultValue:null,description:"Child elements that the tooltip wraps (optional)",name:"children",required:!1,type:{name:"ReactNode"}}}}}catch{}export{u as F};
