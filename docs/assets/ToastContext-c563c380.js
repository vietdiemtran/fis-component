import{j as i}from"./jsx-runtime-47c18db8.js";import{r as m}from"./index-d806aa85.js";import{d as l,g as t,l as e}from"./getTheme-624682de.js";import{F as k}from"./index-96f4e19f.js";import{j as y,k as I,P as w,W as j,l as T}from"./LineArrowsUp-f9d28287.js";import{F as S}from"./index-b5e68206.js";import{c as _}from"./index-d16835b1.js";import{F as C}from"./index-6b2c958e.js";const P=l.div`
  display: flex;
...
`,E={info:i.jsx(I,{}),positive:i.jsx(w,{}),caution:i.jsx(j,{}),negative:i.jsx(T,{})},L={neutral:"com/toast/theme/divider/color-stroke/neutral",info:"com/toast/theme/divider/color-stroke/info",positive:"com/toast/theme/divider/color-stroke/positive",caution:"com/toast/theme/divider/color-stroke/caution",negative:"com/toast/theme/divider/color-stroke/negative"},u=({className:o,theme:a="neutral",type:n="link",actionPosition:r="inline",iconLeft:s,noIcon:c=!1,title:d,actionHref:h,actionLabel:p,closable:x=!0,onClickAction:v})=>{const[g,b]=m.useState(!0),$=m.useMemo(()=>a==="neutral"?s:E[a],[a,s]);return i.jsxs(P,{className:_(o,{hidden:!g}),$theme:a,children:[!c&&i.jsx(q,{children:$}),i.jsxs(N,{$actionPosition:r,$type:n,children:[i.jsx(F,{$theme:a,$actionPosition:r,children:d}),n==="link"&&h&&i.jsx(V,{href:h,target:"_blank",children:p}),n==="button"&&p&&i.jsx(S,{variant:"tertiary",size:"xs",onClick:v,children:p})]}),x&&i.jsxs(i.Fragment,{children:[i.jsx(C,{direction:"vertical",headpointOffset:"tiny",color:L[a]}),i.jsx(k,{size:"xs",icon:i.jsx(y,{}),variant:"tertiary-invisible",onClick:()=>b(!1)})]})]})};u.displayName="FISToast";try{u.displayName="FISToast",u.__docgenInfo={description:"",displayName:"FISToast",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},theme:{defaultValue:{value:"neutral"},description:"",name:"theme",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"info"'},{value:'"positive"'},{value:'"negative"'},{value:'"caution"'}]}},type:{defaultValue:{value:"link"},description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"button"'},{value:'"link"'},{value:'"no-action"'}]}},actionPosition:{defaultValue:{value:"inline"},description:"",name:"actionPosition",required:!1,type:{name:"enum",value:[{value:'"inline"'},{value:'"bottom"'}]}},iconLeft:{defaultValue:null,description:"",name:"iconLeft",required:!1,type:{name:"ReactNode"}},noIcon:{defaultValue:{value:"false"},description:"",name:"noIcon",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},actionHref:{defaultValue:null,description:"",name:"actionHref",required:!1,type:{name:"string"}},actionLabel:{defaultValue:null,description:"",name:"actionLabel",required:!1,type:{name:"string"}},closable:{defaultValue:{value:"true"},description:"",name:"closable",required:!1,type:{name:"boolean"}},onClickAction:{defaultValue:null,description:"",name:"onClickAction",required:!1,type:{name:"(() => void)"}}}}}catch{}const X=m.createContext(void 0),f=({children:o})=>{const[a,n]=m.useState([]),r=m.useCallback(s=>{const c=s.duration||3e3;n(d=>[...d,s]),setTimeout(()=>{n(d=>d.slice(1))},c)},[]);return i.jsxs(X.Provider,{value:{showToast:r},children:[o,a.length>0&&i.jsx(z,{$position:a[0].position||"top-right",children:a.map((s,c)=>i.jsx(u,{...s},c))})]})};try{f.displayName="ToastProvider",f.__docgenInfo={description:"",displayName:"ToastProvider",props:{}}}catch{}export{u as F,f as T,X as a};
