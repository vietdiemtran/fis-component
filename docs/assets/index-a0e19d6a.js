import{j as a}from"./jsx-runtime-47c18db8.js";import{r as w}from"./index-d806aa85.js";import{d as h,l as t}from"./styled-components.browser.esm-c9db8114.js";import{g as e}from"./getTheme-fd88fed7.js";import{a as b,g as v,C as n}from"./helper-57f3ac91.js";const y=h.div`
...
`,m=h.div`
  ...
  ${l=>{let o=[];switch(!l.$hasContent&&!l.$hasDescription&&o.push(t`
      ...
      `),o}}
`,u=w.forwardRef(({className:l,textAlign:o,variant:s=n.PRIMARY,content:i,description:r,icon:c,disabled:d,showBorder:p,onChange:C,contentWrapText:f=!1,onIconClick:g,...$},x)=>a.jsx(y,{$showBorder:p,$disabled:d,$variant:s,$textAlign:o,$contentWrapText:f,$hasContent:i,$hasDescription:r,ref:x,className:`column-cell-container ${l}`,...$,children:o===b.SINGLE_LINE?a.jsxs("div",{className:"single-line-content",children:[c&&a.jsx("div",{className:"icon-box",onClick:g,children:a.jsx(m,{$textAlign:o,$variant:s,$disabled:d,$hasContent:i,$hasDescription:r,children:c})}),(i||r)&&a.jsxs("div",{className:"content-box",children:[i&&a.jsx("div",{className:"content",children:i}),r&&a.jsx("div",{className:"description",children:r})]})]}):a.jsxs("div",{className:"left-right-content",children:[(c||i)&&a.jsxs("div",{className:"content-box",children:[c&&a.jsx(m,{$textAlign:o,$variant:s,$disabled:d,$hasContent:i,$hasDescription:r,children:c}),i&&a.jsx("div",{className:"content",children:i})]}),r&&a.jsx("div",{className:"description",children:r})]})}));u.displayName="FISColumnCell";try{u.displayName="FISColumnCell",u.__docgenInfo={description:"",displayName:"FISColumnCell",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},textAlign:{defaultValue:null,description:"",name:"textAlign",required:!1,type:{name:"string"}},contentWrapText:{defaultValue:{value:"false"},description:"",name:"contentWrapText",required:!1,type:{name:"boolean"}},variant:{defaultValue:{value:"primary"},description:"",name:"variant",required:!1,type:{name:"string"}},content:{defaultValue:null,description:"",name:"content",required:!1,type:{name:"string"}},description:{defaultValue:null,description:"",name:"description",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactElement<any, string | JSXElementConstructor<any>>"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},showBorder:{defaultValue:null,description:"",name:"showBorder",required:!1,type:{name:"boolean"}},onIconClick:{defaultValue:null,description:"",name:"onIconClick",required:!1,type:{name:"(() => void)"}}}}}catch{}export{u as F};
