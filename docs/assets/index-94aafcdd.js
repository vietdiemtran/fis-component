import{j as l}from"./jsx-runtime-50395f49.js";import{d as b,l as r}from"./styled-components.browser.esm-6b0ce59b.js";import{g as o}from"./getTheme-fd88fed7.js";import{r as u}from"./index-9fa1aa67.js";const s=b.button`
  display: flex;
  ...
  ${c=>{switch(c.$variant){case"primary":return r`
        ...
        `;default:return r`
          ...
          color: black;
        `}}}
`,p=u.forwardRef((c,t)=>{const{type:m,children:v,active:e=!1,size:n="md",variant:a="primary",icon:i,...d}=c;return l.jsx(s,{...d,ref:t,$variant:a,$size:n,$active:e,children:i})});try{IconButton.displayName="IconButton",IconButton.__docgenInfo={description:"",displayName:"IconButton",props:{variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'},{value:'"primary-negative"'},{value:'"secondary-negative"'},{value:'"primary-white"'},{value:'"secondary-white"'},{value:'"secondary-invisible"'},{value:'"tertiary-invisible"'},{value:'"secondary-invisible-negative"'},{value:'"secondary-invisible-white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!0,type:{name:"enum",value:[{value:'"sm"'},{value:'"md"'},{value:'"xs"'},{value:'"lg"'}]}},icon:{defaultValue:null,description:"Defines the icon element.",name:"icon",required:!1,type:{name:"ReactNode"}},active:{defaultValue:null,description:"whether the button should be active",name:"active",required:!1,type:{name:"boolean"}}}}}catch{}export{p as F};
