import{j as l}from"./jsx-runtime-47c18db8.js";import{r,R as y}from"./index-d806aa85.js";import{d as n,g as e,l as i}from"./getTheme-624682de.js";const F=n.div`
  width: 100%;
`,L=n.div`
  position: relative;
  display: flex;
...
`,I=n.span`
  display: inline-flex;
  align-items: center;
`,b=n.span``,X=({children:t})=>t,u=({children:t,active:o,defaultActive:p,size:$="md",className:T="",contentClassName:N="",fullWidth:g=!1,onChange:h})=>{var z;const m=r.useMemo(()=>{const a=[];return y.Children.forEach(t,s=>{y.isValidElement(s)&&s.type===X&&a.push(s.props)}),a},[t]),j=o||p||(m.length>0?m[0].value:""),[C,f]=r.useState(j),[q,R]=r.useState({}),c=o!==void 0?o:C,d=r.useRef({}),V=(a,s)=>{s||(o===void 0&&f(a),h==null||h(a))},v=(z=m.find(a=>a.value===c))==null?void 0:z.children;return r.useEffect(()=>{o!==void 0&&f(o)},[o]),r.useEffect(()=>{d.current[c]&&R({width:d.current[c].offsetWidth,left:d.current[c].offsetLeft})},[c]),l.jsxs(F,{className:T,children:[l.jsxs(L,{$fullWidth:g,$size:$,children:[m.map(({value:a,title:s,startIcon:w,endIcon:x,disabled:S,className:_})=>{const D=w&&l.jsx(I,{children:w}),E=x&&l.jsx(I,{children:x});return l.jsxs(P,{ref:k=>d.current[a]=k,$isActive:c===a,$disabled:S,$size:$,className:_,$fullWidth:g,onClick:()=>V(a,S),children:[D,s&&l.jsx(b,{children:s}),E]},a)}),l.jsx(W,{style:q})]}),v&&l.jsx("div",{className:N,children:v})]})};u.displayName="FISTab";try{u.displayName="FISTab",u.__docgenInfo={description:"",displayName:"FISTab",props:{title:{defaultValue:null,description:"The tab control element associated with this pane item",name:"title",required:!1,type:{name:"string"}},startIcon:{defaultValue:null,description:"Defines the element that stands before the children element.",name:"startIcon",required:!1,type:{name:"ReactNode"}},endIcon:{defaultValue:null,description:"Defines the element that stands after the children element.",name:"endIcon",required:!1,type:{name:"ReactNode"}},value:{defaultValue:null,description:"The unique value that identifies this pane item",name:"value",required:!0,type:{name:"string"}},disabled:{defaultValue:null,description:"If true, the pane item will be disabled",name:"disabled",required:!1,type:{name:"boolean"}},className:{defaultValue:{value:""},description:"Custom class name for styling",name:"className",required:!1,type:{name:"string"}},children:{defaultValue:null,description:"The content to be displayed inside the pane",name:"children",required:!0,type:{name:"ReactNode"}}}}}catch{}export{u as F,X as T};
