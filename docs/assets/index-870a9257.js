import{j as c}from"./jsx-runtime-50395f49.js";import{r as $}from"./index-9fa1aa67.js";import{d,l as i}from"./styled-components.browser.esm-6b0ce59b.js";import{g as o}from"./getTheme-fd88fed7.js";const p=d.div`
  overflow: hidden;
  display: inline-flex;
...
`,l=d.span`
  display: inline-flex;
  align-items: center;
`,k=({size:t="md",disabled:e=!1,options:n,variant:a})=>c.jsx(p,{children:n.map((s,r)=>$.createElement(f,{...s,key:r,disabledContainer:e,size:t,variant:a}))}),f=({disabledContainer:t,startIcon:e,endIcon:n,size:a="md",variant:s="default",label:r,disabled:u,...b})=>{const m=!!(!r&&(!e&&n||e&&!n)),g=e&&c.jsx(l,{className:"button-icon",children:e}),h=n&&c.jsx(l,{className:"button-icon",children:n});return c.jsxs(z,{...b,disabled:t||u,$onlyIcon:m,$size:a,$variant:s,children:[g,r&&c.jsx("span",{className:"button-content",children:r}),h]})};try{GroupButton.displayName="GroupButton",GroupButton.__docgenInfo={description:"",displayName:"GroupButton",props:{variant:{defaultValue:{value:"default"},description:"Variant of the buttons. 'default' is typically used for text-only buttons",name:"variant",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"negative"'}]}},size:{defaultValue:{value:"md"},description:"Size of the buttons. 'md' is typically used for icon-only buttons",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},disabled:{defaultValue:{value:"false"},description:"Disabled state of all buttons in the group",name:"disabled",required:!1,type:{name:"boolean"}},options:{defaultValue:null,description:"List of button options",name:"options",required:!0,type:{name:"ButtonOption[]"}}}}}catch{}export{k as F};
