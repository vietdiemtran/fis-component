import{j as t}from"./jsx-runtime-C8_8iAox.js";import{r as x}from"./index-Dkaqzkgy.js";import{l as r,d as n}from"./styled-components.browser.esm-CcLIA1IU.js";import{g as e}from"./getTheme-atTn6El8.js";import{c as y,I as v}from"./RequestButtonLoadingIcon-XHoBIMsM.js";const i=n.span`
  display: inline-flex;
  align-items: center;
...
`,z=n.label`
  ...
  ${o=>{switch(o.$variant){case"primary":return r`
        ...
        `}}}
`,L=x.forwardRef(({className:o,children:c,subLabel:s,checked:d=!1,indeterminate:h=!1,disabled:m=!1,size:u="md",variant:$="primary",inputRef:p,...f},g)=>{const b=`checkbox-${x.useId()}`;return t.jsxs(z,{ref:g,className:o,$checked:d,$indeterminate:h,$disabled:m,$size:u,$variant:$,children:[t.jsxs(i,{tabIndex:m?-1:0,children:[t.jsx(w,{...f,ref:p,type:"checkbox",checked:d,disabled:m,"aria-labelledby":c?b:void 0}),d?t.jsx(y,{}):null,!d&&h?t.jsx(v,{}):null]}),(c||s)&&t.jsxs(a,{children:[c&&t.jsx(k,{id:b,children:c}),s&&t.jsx(l,{children:s})]})]})});try{Checkbox.displayName="Checkbox",Checkbox.__docgenInfo={description:"",displayName:"Checkbox",props:{variant:{defaultValue:{value:"primary"},description:"Type of checkbox",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'}]}},subLabel:{defaultValue:null,description:"Defines the string that subLabel the checkbox element.",name:"subLabel",required:!1,type:{name:"string"}},indeterminate:{defaultValue:{value:"false"},description:"If `true`, the checkbox will be checked.\nYou'll need to pass `onChange` to update its value (since it is now controlled).",name:"indeterminate",required:!1,type:{name:"boolean"}},inputRef:{defaultValue:{value:"false"},description:"If `true`, the checkbox will be disabled.",name:"inputRef",required:!1,type:{name:"Ref<HTMLInputElement>"}}}}}catch{}export{L as F};
