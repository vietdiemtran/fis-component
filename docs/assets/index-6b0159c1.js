...
`,p=o.div`
  ...
  ${r=>{switch(r.$statusBadge){case"green":return a`
        ...
        `}}}
`,d=({className:r,src:l,alt:h="Avatar",shape:s="rounded",size:i="xl",icon:u,statusBadge:$="green",color:n="neutral",letter:m,disabled:c,dotBadge:v=!1})=>t.jsxs(g,{className:r,$size:i,$shape:s,$color:n,$disabled:c,tabIndex:c?-1:0,children:[l?t.jsxs(b,{$shape:s,children:[t.jsx(x,{$shape:s,$size:i,src:l,alt:h}),c&&t.jsx(z,{})]}):u?t.jsx(w,{$size:i,$shape:s,$color:n,$disabled:c,children:u}):t.jsx(k,{$size:i,$shape:s,$color:n,$disabled:c,children:m==null?void 0:m.slice(0,2)}),v&&t.jsx(p,{$size:i,$statusBadge:$})]});d.displayName="FISAvatar";const q=d;try{d.displayName="FISAvatar",d.__docgenInfo={description:"",displayName:"FISAvatar",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},src:{defaultValue:null,description:"",name:"src",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},alt:{defaultValue:{value:"Avatar"},description:"",name:"alt",required:!1,type:{name:"string"}},letter:{defaultValue:null,description:"",name:"letter",required:!1,type:{name:"string"}},size:{defaultValue:{value:"xl"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"2xs"'},{value:'"xl"'}]}},statusBadge:{defaultValue:{value:"green"},description:"",name:"statusBadge",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"red"'},{value:'"yellow"'},{value:'"green"'},{value:'"blue"'}]}},dotBadge:{defaultValue:{value:"false"},description:"",name:"dotBadge",required:!1,type:{name:"boolean"}},shape:{defaultValue:{value:"rounded"},description:"",name:"shape",required:!1,type:{name:"enum",value:[{value:'"rounded"'},{value:'"square"'}]}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},color:{defaultValue:{value:"neutral"},description:"",name:"color",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"orange"'},{value:'"yellow"'},{value:'"lime"'},{value:'"green"'},{value:'"ocean"'},{value:'"blue"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}}}}}catch{}export{q as F};
