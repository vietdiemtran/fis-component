import{j as i}from"./jsx-runtime-47c18db8.js";import{r as R,R as s}from"./index-d806aa85.js";import{g as e}from"./getTheme-fd88fed7.js";import{c as l}from"./index-d16835b1.js";import{d as n}from"./styled-components.browser.esm-c9db8114.js";import{F as Z}from"./index-218a7fe1.js";import{b as ee}from"./DeleteIcon-619c489d.js";import{F as te}from"./index-685bf6c1.js";const ie=n.div`
  display: flex;
...
`;n.div`
  ${e("Paragraph/XS")};
  color: ${e("com/input/hint/neutral/label/color-text")};
`;const u=R.forwardRef((v,F)=>{var C;const{className:D,required:H=!1,textLabel:x="",iconLabel:y,iconSuffix:r,disabled:z=!1,readOnly:re=!1,negative:p,message:k,positive:_,maxLength:m=50,showCount:A,size:g="md",fixedWidth:w,onClickIconLabel:P,onClickIconSuffix:W,onChange:f,onEnter:h,...X}=v,[c,S]=s.useState(""),o=s.useRef(null),B=s.useCallback(t=>{S(t.target.value),f&&f(t)},[f]),M=s.useCallback(t=>{t&&t.key==="Enter"&&h&&h(t.currentTarget.value)},[h]);R.useImperativeHandle(F,()=>({...o.current,focus:()=>{o.current&&o.current.focus()},blur:()=>{o.current&&o.current.blur()},clear:()=>{o.current&&(o.current.value="",S(""))}}));const T=t=>{t.preventDefault(),t.stopPropagation();const d=o.current;if(!d)return;const I=d.getBoundingClientRect(),K=t.clientX,Y=t.clientY,O=I.width,Q=I.height,j=b=>{b.preventDefault();const a=document.getElementById("resizeHandle"),E=a?a.offsetWidth:10,N=e("sem/typo/paragraph/line-height/sm"),G=N&&parseInt(N.toString(),10)||20,J=Math.max(O+(b.clientX-K)-E),U=Math.max(G,Q+(b.clientY-Y)-E);d.style.width=`${J}px`,d.style.height=`${U}px`,a&&(a.style.right="-2px",a.style.bottom="-2px")},L=()=>{document.body.style.cursor="",document.removeEventListener("mousemove",j),document.removeEventListener("mouseup",L)};document.addEventListener("mousemove",j),document.addEventListener("mouseup",L)};return i.jsxs(ie,{className:D,children:[(x||y)&&i.jsx(te,{textLabel:x,required:H,iconLabel:y,onClickIconLabel:P}),i.jsxs(oe,{className:l({"input-area-lg":g==="lg","input-area-icon":r,negative:p}),style:{width:w?`${w}px`:"auto"},children:[i.jsx($,{...X,onChange:B,onKeyDown:M,ref:o,disabled:z,className:l({negative:p,"input-area-lg":g==="lg","input-area-icon":r})}),r&&i.jsx(V,{className:l({"input-area-lg":g==="lg"}),children:i.jsx(Z,{variant:"tertiary-invisible",size:"sm",icon:r,onClick:W})}),i.jsx(q,{id:"resizeHandle",onMouseDown:T,children:i.jsx(ee,{})})]}),i.jsxs(le,{children:[i.jsx(ae,{className:l({disabled:z,negative:p,positive:_}),children:k||""}),i.jsx(ne,{children:A&&m>0&&i.jsxs("span",{className:l("text-area__count",{negative:c.length>m}),children:[(C=c==null?void 0:c.replaceAll(`
`,""))==null?void 0:C.length,"/",m]})})]})]})});u.displayName="FISInputArea";const he=u;try{u.displayName="FISInputArea",u.__docgenInfo={description:"",displayName:"FISInputArea",props:{iconSuffix:{defaultValue:null,description:"Control the icon of the component",name:"iconSuffix",required:!1,type:{name:"ReactNode"}},size:{defaultValue:null,description:"Control the size of the component",name:"size",required:!1,type:{name:"enum",value:[{value:'"md"'},{value:'"lg"'}]}},showCount:{defaultValue:null,description:"Boolean to show the lenght of value user-filled",name:"showCount",required:!1,type:{name:"boolean"}},negative:{defaultValue:null,description:"isNegative for current field",name:"negative",required:!1,type:{name:"boolean"}},positive:{defaultValue:null,description:"isPositive for current field",name:"positive",required:!1,type:{name:"boolean"}},message:{defaultValue:null,description:"positiveMessage for current field",name:"message",required:!1,type:{name:"string"}},fixedWidth:{defaultValue:null,description:"Control the width of the component",name:"fixedWidth",required:!1,type:{name:"number"}},onEnter:{defaultValue:null,description:"Handle onEnter action",name:"onEnter",required:!1,type:{name:"((T: string | null) => void)"}},onClickIconSuffix:{defaultValue:null,description:"Handle onEnter action",name:"onClickIconSuffix",required:!1,type:{name:"(() => void)"}},textLabel:{defaultValue:null,description:"textLabel for current field",name:"textLabel",required:!1,type:{name:"string"}},iconLabel:{defaultValue:null,description:"Icon for current field",name:"iconLabel",required:!1,type:{name:"ReactNode"}},onClickIconLabel:{defaultValue:null,description:"onClickIconLabel for current field",name:"onClickIconLabel",required:!1,type:{name:"(() => void)"}}}}}catch{}export{he as F};
