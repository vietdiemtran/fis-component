import{j as b}from"./jsx-runtime-47c18db8.js";import{d as u,g as o,l as r}from"./getTheme-21dde6f8.js";import{r as s}from"./index-d806aa85.js";const m=u.button`
  display: flex;
  ...
  ${c=>{switch(c.$variant){case"primary":return r`
        ...
        `;default:return r`
          ...
          color: black;
        `}}}
`,e=s.forwardRef((c,t)=>{const{type:v,children:$,active:n=!1,size:a="md",variant:i="primary",icon:d,...l}=c;return b.jsx(m,{...l,ref:t,$variant:i,$size:a,$active:n,children:d})});e.displayName="FISIconButton";try{e.displayName="FISIconButton",e.__docgenInfo={description:"",displayName:"FISIconButton",props:{variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'},{value:'"primary-negative"'},{value:'"secondary-negative"'},{value:'"primary-white"'},{value:'"secondary-white"'},{value:'"secondary-invisible"'},{value:'"tertiary-invisible"'},{value:'"secondary-invisible-negative"'},{value:'"secondary-invisible-white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},icon:{defaultValue:null,description:"Defines the icon element.",name:"icon",required:!1,type:{name:"ReactNode"}},active:{defaultValue:null,description:"whether the button should be active",name:"active",required:!1,type:{name:"boolean"}}}}}catch{}export{e as F};
