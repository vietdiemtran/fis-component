import{j as l}from"./jsx-runtime-e7d94ccb.js";import{a,g as o,r as n}from"./getTheme-9564f801.js";import{r as h}from"./index-981f9478.js";const v=a.button`
  display: flex;
...
`,r=a.span`
  display: inline-flex;
  align-items: center;
`,i=h.forwardRef((e,s)=>{const{children:d,size:u="sm",variant:m="default",underline:b,startIcon:t,endIcon:c,singleLine:f=!1,...p}=e,$=t&&l.jsx(r,{className:"button-icon",children:t}),k=c&&l.jsx(r,{className:"button-icon",children:c});return l.jsxs(v,{...p,ref:s,$variant:m,$size:u,$underline:b,$singleLine:f,children:[$,l.jsx("span",{className:"button-content",children:d}),k]})});i.displayName="FISLinkButton";try{i.displayName="FISLinkButton",i.__docgenInfo={description:"",displayName:"FISLinkButton",props:{variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"negative"'},{value:'"default"'},{value:'"hight-priority"'},{value:'"white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'}]}},startIcon:{defaultValue:null,description:"Defines the element that stands before the children element.",name:"startIcon",required:!1,type:{name:"ReactNode"}},endIcon:{defaultValue:null,description:"Defines the element that stands after the children element.",name:"endIcon",required:!1,type:{name:"ReactNode"}},underline:{defaultValue:null,description:"Defines the type of the button.",name:"underline",required:!1,type:{name:"boolean"}},singleLine:{defaultValue:null,description:"If true, text will be truncated with ellipsis on single line",name:"singleLine",required:!1,type:{name:"boolean"}}}}}catch{}export{i as F};
