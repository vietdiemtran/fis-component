import{j as t}from"./jsx-runtime-47c18db8.js";import{d as o,l as a,g as e}from"./getTheme-624682de.js";const g=o.div`
  position: relative;
  display: flex;
  align-items: center;
...
`,p=o.div`
  ...
  ${r=>{switch(r.$statusBadge){case"green":return a`
        ...
        `}}}
`,d=({className:r,src:l,alt:h="Avatar",shape:s="rounded",size:i="xl",icon:u,statusBadge:$="green",color:n="neutral",letter:m,disabled:c,dotBadge:v=!1})=>t.jsxs(g,{className:r,$size:i,$shape:s,$color:n,$disabled:c,tabIndex:c?-1:0,children:[l?t.jsxs(b,{$shape:s,children:[t.jsx(x,{$shape:s,$size:i,src:l,alt:h}),c&&t.jsx(z,{})]}):u?t.jsx(w,{$size:i,$shape:s,$color:n,$disabled:c,children:u}):t.jsx(k,{$size:i,$shape:s,$color:n,$disabled:c,children:m==null?void 0:m.slice(0,2)}),v&&t.jsx(p,{$size:i,$statusBadge:$})]});d.displayName="FISAvatar";const q=d;try{d.displayName="FISAvatar",d.__docgenInfo={description:"",displayName:"FISAvatar",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},src:{defaultValue:null,description:"",name:"src",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},alt:{defaultValue:{value:"Avatar"},description:"",name:"alt",required:!1,type:{name:"string"}},letter:{defaultValue:null,description:"",name:"letter",required:!1,type:{name:"string"}},size:{defaultValue:{value:"xl"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"2xs"'},{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"xl"'}]}},statusBadge:{defaultValue:{value:"green"},description:"",name:"statusBadge",required:!1,type:{name:"enum",value:[{value:'"green"'},{value:'"red"'},{value:'"yellow"'},{value:'"blue"'},{value:'"neutral"'}]}},dotBadge:{defaultValue:{value:"false"},description:"",name:"dotBadge",required:!1,type:{name:"boolean"}},shape:{defaultValue:{value:"rounded"},description:"",name:"shape",required:!1,type:{name:"enum",value:[{value:'"rounded"'},{value:'"square"'}]}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},color:{defaultValue:{value:"neutral"},description:"",name:"color",required:!1,type:{name:"enum",value:[{value:'"green"'},{value:'"yellow"'},{value:'"blue"'},{value:'"neutral"'},{value:'"orange"'},{value:'"lime"'},{value:'"ocean"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}}}}}catch{}export{q as F};
