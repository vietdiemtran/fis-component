import{j as i}from"./jsx-runtime-47c18db8.js";import{r as w}from"./index-d806aa85.js";import{d as l,g as e,l as o}from"./getTheme-624682de.js";import{F as v}from"./index-6b0159c1.js";import{F as z}from"./index-e72c950e.js";import{b as x}from"./RemoveIcon-d554efb7.js";import{c as a}from"./index-d16835b1.js";const y=l.div`
  display: flex;
  align-items: center;
...
`,n=w.forwardRef((t,m)=>{const{className:b,icon:u,label:p,size:c="xs",theme:d="neutral",srcAvatar:h="",closeable:s,selected:g,disabled:r,onClickClose:$,...k}=t,f=c==="xs"?"2xs":c==="sm"?"xs":c==="md"?"sm":"md";return i.jsxs(y,{...k,ref:m,$size:c,$theme:d,$disabled:r,className:a(b,{selected:g,"no-padding":s,"no-padding-horizontal":!s&&!u&&!h}),children:[h?i.jsx(v,{size:f,src:h,disabled:r,dotBadge:!r}):u&&i.jsx(C,{$size:c,$theme:d,$disabled:r,children:u}),i.jsx(j,{$size:c,$theme:d,$disabled:r,className:a({"no-padding":s}),children:p}),s&&i.jsx(S,{$size:c,$disabled:r,className:"button-icon",children:i.jsx(z,{size:c,variant:"tertiary-invisible",icon:i.jsx(x,{}),onClick:$,disabled:r})})]})});n.displayName="FISChipButton";const L=n;try{n.displayName="FISChipButton",n.__docgenInfo={description:"",displayName:"FISChipButton",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},size:{defaultValue:null,description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},theme:{defaultValue:null,description:"",name:"theme",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"red"'},{value:'"orange"'},{value:'"yellow"'},{value:'"lime"'},{value:'"green"'},{value:'"ocean"'},{value:'"blue"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}},closeable:{defaultValue:null,description:"",name:"closeable",required:!1,type:{name:"boolean"}},selected:{defaultValue:null,description:"",name:"selected",required:!1,type:{name:"boolean"}},disabled:{defaultValue:null,description:"",name:"disabled",required:!1,type:{name:"boolean"}},onClickClose:{defaultValue:null,description:"",name:"onClickClose",required:!1,type:{name:"(() => void)"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},label:{defaultValue:null,description:"",name:"label",required:!0,type:{name:"string"}},srcAvatar:{defaultValue:null,description:"",name:"srcAvatar",required:!1,type:{name:"string"}}}}}catch{}export{L as F};
