import{j as t}from"./jsx-runtime-47c18db8.js";import{r as d}from"./index-d806aa85.js";import{d as l,g as e,l as a}from"./getTheme-624682de.js";import{F as k}from"./index-96f4e19f.js";import{j as y,k as j,P as I,W as _,l as T}from"./LineArrowsUp-4acd88f0.js";import{F as S}from"./index-b5e68206.js";import{c as P}from"./index-d16835b1.js";import{F as C}from"./index-6b2c958e.js";const F=l.div`
  display: flex;
...
`,z=l.div`
  position: fixed;
  ${o=>o.$position==="bottom-center"?"bottom: 20px;":"top: 20px;"}
  left: 50%;
  ...
  flex-direction: column;
  gap: 8px;
`,E={info:t.jsx(j,{}),positive:t.jsx(I,{}),caution:t.jsx(_,{}),negative:t.jsx(T,{})},L={neutral:"com/toast/theme/divider/color-stroke/neutral",info:"com/toast/theme/divider/color-stroke/info",positive:"com/toast/theme/divider/color-stroke/positive",caution:"com/toast/theme/divider/color-stroke/caution",negative:"com/toast/theme/divider/color-stroke/negative"},u=({className:o,theme:i="neutral",type:n="link",actionPosition:m="inline",iconLeft:r,noIcon:s=!1,title:c,actionHref:v,actionLabel:p,closable:g=!0,onClickAction:h})=>{const[x,$]=d.useState(!0),b=d.useMemo(()=>i==="neutral"?r:E[i],[i,r]);return t.jsxs(F,{className:P(o,{hidden:!x}),$theme:i,children:[!s&&t.jsx(V,{children:b}),t.jsxs(N,{$actionPosition:m,$type:n,children:[t.jsx(q,{$theme:i,$actionPosition:m,children:c}),n==="link"&&v&&t.jsx(w,{href:v,target:"_blank",children:p}),n==="button"&&p&&t.jsx(S,{variant:"tertiary",size:"xs",onClick:h,children:p})]}),g&&t.jsxs(t.Fragment,{children:[t.jsx(C,{direction:"vertical",headpointOffset:"tiny",color:L[i]}),t.jsx(k,{size:"xs",icon:t.jsx(y,{}),variant:"tertiary-invisible",onClick:()=>$(!1)})]})]})};u.displayName="FISToast";try{u.displayName="FISToast",u.__docgenInfo={description:"",displayName:"FISToast",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},theme:{defaultValue:{value:"neutral"},description:"",name:"theme",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"info"'},{value:'"positive"'},{value:'"negative"'},{value:'"caution"'}]}},type:{defaultValue:{value:"link"},description:"",name:"type",required:!1,type:{name:"enum",value:[{value:'"button"'},{value:'"link"'},{value:'"no-action"'}]}},actionPosition:{defaultValue:{value:"inline"},description:"",name:"actionPosition",required:!1,type:{name:"enum",value:[{value:'"inline"'},{value:'"bottom"'}]}},iconLeft:{defaultValue:null,description:"",name:"iconLeft",required:!1,type:{name:"ReactNode"}},noIcon:{defaultValue:{value:"false"},description:"",name:"noIcon",required:!1,type:{name:"boolean"}},title:{defaultValue:null,description:"",name:"title",required:!0,type:{name:"string"}},actionHref:{defaultValue:null,description:"",name:"actionHref",required:!1,type:{name:"string"}},actionLabel:{defaultValue:null,description:"",name:"actionLabel",required:!1,type:{name:"string"}},closable:{defaultValue:{value:"true"},description:"",name:"closable",required:!1,type:{name:"boolean"}},onClickAction:{defaultValue:null,description:"",name:"onClickAction",required:!1,type:{name:"(() => void)"}}}}}catch{}const D=d.createContext(void 0),f=({children:o})=>{const[i,n]=d.useState([]),m=d.useCallback(r=>{const s=r.duration||3e3;n(c=>[...c,r]),setTimeout(()=>{n(c=>c.slice(1))},s)},[]);return t.jsxs(D.Provider,{value:{showToast:m},children:[o,i.length>0&&t.jsx(z,{$position:i[0].position||"top-center",children:i.map((r,s)=>t.jsx(u,{...r},s))})]})};try{f.displayName="ToastProvider",f.__docgenInfo={description:"",displayName:"ToastProvider",props:{}}}catch{}export{u as F,f as T,D as a};
