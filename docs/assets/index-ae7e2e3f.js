import{j as t}from"./jsx-runtime-47c18db8.js";import{d as o,l as a}from"./styled-components.browser.esm-c9db8114.js";import{g as e}from"./getTheme-fd88fed7.js";const g=o.div`
  position: relative;
  display: flex;
  align-items: center;
...
`,k=o.div`
  ...
  ${r=>{switch(r.$status){case"green":return a`
        ...
        `}}}
`,n=({className:r,src:l,alt:u="Avatar",badge:s="rounded",size:i="xl",icon:m,status:h="green",color:d="neutral",letter:$,isBadgeDot:v=!1,disable:c=!1})=>t.jsxs(g,{className:r,$size:i,$badge:s,$color:d,$disable:c,children:[l?t.jsxs(b,{$badge:s,$size:i,children:[t.jsx(x,{$badge:s,src:l,alt:u,$size:i}),c&&t.jsx(z,{})]}):m?t.jsx(w,{$size:i,$badge:s,$color:d,$disable:c,children:m}):t.jsx(p,{$size:i,$badge:s,$color:d,$disable:c,children:$}),v&&t.jsx(k,{$size:i,$status:h})]});n.displayName="FISAvatar";const j=n;try{n.displayName="FISAvatar",n.__docgenInfo={description:"",displayName:"FISAvatar",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},src:{defaultValue:null,description:"",name:"src",required:!1,type:{name:"string"}},icon:{defaultValue:null,description:"",name:"icon",required:!1,type:{name:"ReactNode"}},alt:{defaultValue:{value:"Avatar"},description:"",name:"alt",required:!1,type:{name:"string"}},letter:{defaultValue:null,description:"",name:"letter",required:!1,type:{name:"string"}},size:{defaultValue:{value:"xl"},description:"",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'},{value:'"2xs"'},{value:'"xl"'}]}},status:{defaultValue:{value:"green"},description:"",name:"status",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"red"'},{value:'"yellow"'},{value:'"green"'},{value:'"blue"'}]}},isBadgeDot:{defaultValue:{value:"false"},description:"",name:"isBadgeDot",required:!1,type:{name:"boolean"}},badge:{defaultValue:{value:"rounded"},description:"",name:"badge",required:!1,type:{name:"enum",value:[{value:'"rounded"'},{value:'"square"'},{value:'"without"'}]}},color:{defaultValue:{value:"neutral"},description:"",name:"color",required:!1,type:{name:"enum",value:[{value:'"neutral"'},{value:'"orange"'},{value:'"yellow"'},{value:'"lime"'},{value:'"green"'},{value:'"ocean"'},{value:'"blue"'},{value:'"indigo"'},{value:'"violet"'},{value:'"pink"'}]}},disable:{defaultValue:{value:"false"},description:"",name:"disable",required:!1,type:{name:"boolean"}}}}}catch{}export{j as F};
