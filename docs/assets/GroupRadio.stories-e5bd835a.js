import{j as y}from"./jsx-runtime-50395f49.js";import{r as G}from"./index-9fa1aa67.js";import{R}from"./index-2a6cc9bc.js";import"./index-fcd6afa8.js";import"./styled-components.browser.esm-6b0ce59b.js";import"./getTheme-fd88fed7.js";const I={title:"Components/Radio group",component:R,tags:["autodocs"],argTypes:{direction:{control:{type:"radio"},options:["row","column"],description:"Defines the layout direction of the radio group."},disabled:{control:{type:"boolean"},description:"Disables all radio options if set to true."},value:{control:{type:"text"},description:"Sets the selected radio button value."}}},r=l=>{const[D,x]=G.useState(l.value);return y.jsx(R,{...l,value:D,onChange:x})},e=r.bind({});e.args={groupLabel:"Choose an option",options:[{value:"option1",label:"Option 1"},{value:"option2",label:"Option 2"},{value:"option3",label:"Option 3"}],value:"option1",direction:"row",disabled:!1};const a=r.bind({});a.args={...e.args,disabled:!0};const t=r.bind({});t.args={...e.args,direction:"column"};const o=r.bind({});o.args={...e.args,getOptionDisabled:l=>l.value==="option2"};const s=r.bind({});s.args={...e.args,value:null};var n,u,i;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`args => {
  ...
  const [selectedValue, setSelectedValue] = useState<string | null>(args.value);
  return <RadioGroup {...args} value={selectedValue} onChange={setSelectedValue} />;
}`,...(f=(C=s.parameters)==null?void 0:C.docs)==null?void 0:f.source}}};const N=["Default","Disabled","ColumnLayout","WithCustomDisabledOptions","NoInitialSelection"];export{t as ColumnLayout,e as Default,a as Disabled,s as NoInitialSelection,o as WithCustomDisabledOptions,N as __namedExportsOrder,I as default};
