import{j as c}from"./jsx-runtime-47c18db8.js";import{d as a,l as e,m as x}from"./styled-components.browser.esm-c9db8114.js";import{g as o}from"./getTheme-fd88fed7.js";import{R as z,a as w}from"./DeleteIcon-619c489d.js";import{r as I}from"./index-d806aa85.js";const n=(r,i)=>{const l=o(`com/button/size-${r}/horizontal-padding`),s=o(i);return e`
    padding: 0 calc(${l} - ${s});
  `},S=a.button`
  display: flex;
...
`,L=a(z)`
  position: absolute;
  animation: ${g} 0.9s linear infinite;
`,j=a(w)`
  position: absolute;
  animation: ${g} 0.9s linear infinite;
`,u=I.forwardRef((r,i)=>{const{active:l,type:s,children:v,size:p="md",variant:d="primary",loading:b,disabled:h=!1,startIcon:m,endIcon:$,...y}=r,k=m&&c.jsx(t,{children:m}),f=$&&c.jsx(t,{children:$});return c.jsxs(S,{...y,ref:i,$variant:d,$size:p,$active:l,$loading:b,disabled:h||b,children:[b&&(d==="primary-white"||d==="secondary-white"?c.jsx(L,{}):c.jsx(j,{})),k,c.jsx("span",{className:"button-content",children:v}),f]})});u.displayName="FISButton";try{u.displayName="FISButton",u.__docgenInfo={description:"",displayName:"FISButton",props:{active:{defaultValue:null,description:"whether the button should be active",name:"active",required:!1,type:{name:"boolean"}},variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'},{value:'"primary-negative"'},{value:'"secondary-negative"'},{value:'"primary-white"'},{value:'"secondary-white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},startIcon:{defaultValue:null,description:"Defines the element that stands before the children element.",name:"startIcon",required:!1,type:{name:"ReactNode"}},endIcon:{defaultValue:null,description:"Defines the element that stands after the children element.",name:"endIcon",required:!1,type:{name:"ReactNode"}},loading:{defaultValue:null,description:"Defines if the button is currently being requested.",name:"loading",required:!1,type:{name:"boolean"}}}}}catch{}export{u as F};
