import{j as c}from"./jsx-runtime-47c18db8.js";import{d as s,g as o,l as e}from"./getTheme-624682de.js";import{F as k}from"./index-8298a7d1.js";import{r as f}from"./index-d806aa85.js";const n=(r,a)=>{const i=o(`com/button/size-${r}/horizontal-padding`),l=o(a);return e`
    padding: 0 calc(${i} - ${l});
  `},z=s.button`
  display: flex;
...
`,x=s(k)`
  position: absolute;
`,u=f.forwardRef((r,a)=>{const{active:i,children:l,size:m="md",variant:d="primary",loading:b,disabled:v=!1,startIcon:$,endIcon:g,...p}=r,y=$&&c.jsx(t,{children:$}),h=g&&c.jsx(t,{children:g});return c.jsxs(z,{...p,ref:a,$variant:d,$size:m,$active:i,$loading:b,disabled:v||b,children:[b&&c.jsx(x,{size:m,variant:"indeterminate",invert:d==="primary-white"||d==="secondary-white"}),y,c.jsx("span",{className:"button-content",children:l}),h]})});u.displayName="FISButton";try{u.displayName="FISButton",u.__docgenInfo={description:"",displayName:"FISButton",props:{active:{defaultValue:null,description:"whether the button should be active",name:"active",required:!1,type:{name:"boolean"}},variant:{defaultValue:null,description:"Change the design of button",name:"variant",required:!1,type:{name:"enum",value:[{value:'"primary"'},{value:'"secondary"'},{value:'"tertiary"'},{value:'"primary-negative"'},{value:'"secondary-negative"'},{value:'"primary-white"'},{value:'"secondary-white"'}]}},size:{defaultValue:null,description:"Size md for only button icon",name:"size",required:!1,type:{name:"enum",value:[{value:'"xs"'},{value:'"sm"'},{value:'"md"'},{value:'"lg"'}]}},startIcon:{defaultValue:null,description:"Defines the element that stands before the children element.",name:"startIcon",required:!1,type:{name:"ReactNode"}},endIcon:{defaultValue:null,description:"Defines the element that stands after the children element.",name:"endIcon",required:!1,type:{name:"ReactNode"}},loading:{defaultValue:null,description:"Defines if the button is currently being requested.",name:"loading",required:!1,type:{name:"boolean"}}}}}catch{}export{u as F};
